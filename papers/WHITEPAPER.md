...
## 2. The Proposal / La Propuesta

### 2.1 Principles / Principios

1. **EN:** Data never leaves the professional's device.  
   **ES:** Los datos nunca salen del dispositivo del profesional.
2. **EN:** AI runs locally.  
   **ES:** La IA corre localmente.
3. **EN:** Code is auditable.  
   **ES:** El código es auditable.
4. **EN:** Therapist has absolute control.  
   **ES:** El terapeuta tiene control absoluto.
5. **EN:** Cryptography is the boundary, not policy.  
   **ES:** La criptografía es el límite, no la política.
...
## 3. Clinical Practice Implications / Implicaciones Clínicas
